  ...
  return (
    <div className="preNavBar">
      <div>
        ...
        <span>|</span>
        <a href="https://www.mi.com">ONLINE HELP</a>
        <span>|</span>
        <a href="https://www.mi.com">RETIAL STORE</a>
      </div>
      <div>
        <a href="<span></span>">SIGN IN</a>
        <a href="https://www.mi.com">SIGN UP</a> <span>|</span>
        <a href="https://www.mi.com"> {cartIcon} CART(0)</a>
      </div>
    </div>
  );
}
